      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "order in successfully");
            }
            _context.next = 12;
            break;
          case 9:
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        procedOrderbtn.textContent = "proceed to order";
                        _context.next = 3;
...
},{"./login":"login.js","./Search":"Search.js","./pagination":"pagination.js","./booking":"booking.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
